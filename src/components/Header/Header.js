    ...
    return (
        <div className='header'>
            ...
            <div className="header__cart-block-links">
                ...
                <div className="header__favorite header__cart-block-link">
                    <Svg type='heart'/>
                ...
                <div className="header__cart header__cart-block-link">
                    <div className="header__cart-block-link">
                        <Svg type='bag'/>
                        {countInCart ? <span className='count'>{countInCart}</span> : null}
                    </div>
                     <span className='header__total-price'>${totalPrice || 0}</span>
                </div>
            </div>
        </div>
    )
